object FunctionalProgramming extends App {
    ...
    Conclusion: FunctionX = Function1, Function2, ... Function22 <- 22 is max number of functions
    */
    ...
    // syntax sugars
    val doubler: Int => Int = (x: Int) => 2 * x //Int => Int is optional
    doubler(4) // 8
    ...
    */
    ...
    val aFlatMappedList = List(1,2,3).flatMap { x =>
        List(x, 2 * x) //flatmap concat lists
